...
const initializeThroughput = (gates) => {
  const summary = {};
...
const processGateFlow = (gate, tickIndex) => {
...
const rerouteOverflow = (gates, currentGate, tickIndex, overflowAmount) => {
...
const handleGateAtTick = (gates, gate, tickIndex, throughputSummary) => {
  console.log("\nProcessing " + gate.id + "...");
  console.log(
...
const simulateFestival = (gates, timeBlock) => {
